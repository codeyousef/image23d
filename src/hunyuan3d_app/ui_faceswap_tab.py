...
from .face_swap import FaceRestoreModel, BlendMode, FaceSwapParams
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Swap Settings", open=True):
                        source_face_index = gr.Number(
                            ...
                            info="Which face to use from source (0 = first face)"
                        )
                        ...
                        similarity_threshold = gr.Slider(
                            ...
                            info="Only swap faces above this similarity"
                        )
