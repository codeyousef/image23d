    ...
    def load_gguf_flux_model(
        ...
        try:
            if progress_callback:
                progress_callback(0.1, f"Loading GGUF transformer from {gguf_file_path.name}")
            ...
            if progress_callback:
                progress_callback(0.5, "Loading text encoders")
            ...
            if progress_callback:
                progress_callback(0.7, "Creating pipeline")
            ...
            if progress_callback:
                progress_callback(1.0, "GGUF model loaded successfully")
