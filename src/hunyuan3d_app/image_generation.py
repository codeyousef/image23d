...
"""
        ...
        try:
            ...
            progress(0.1, desc="Preparing for image generation...")
            ...
            while not result_container["completed"]:
                ...
                if self.stop_generation_flag and not result_container["stopped"]:
                    progress(min(0.1 + (0.85 * (result_container["current_step"] / steps)), 0.95), 
                            desc=f"Stopping generation at step {result_container['current_step']}/{steps}...")
                ...
                if current_step > last_step or current_step == 0:
                    ...
                    progress(min(progress_value, 0.95), desc=progress_msg)
            ...
            if result_container["stopped"]:
                progress(1.0, desc="Image generation stopped!")
            else:
